...
def test_process_image_ocr_success(mock_reader, processor, sample_image):
    ...
    # Mock OCR results
    mock_results = [([[0, 0], [100, 0], [100, 30], [0, 30]], "Sample text", 0.95)]
...
@patch("easyocr.Reader")
@patch("ollama.Client")
def test_process_document_with_ocr(
    mock_ollama, mock_reader, mock_fitz_open, processor, sample_image
):
